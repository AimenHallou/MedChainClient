    ...
    <Dialog open={addPatientDialogOpen} onOpenChange={setAddPatientDialogOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <Form {...addPatientForm}>
          <form
            id="addPatientForm"
            onSubmit={addPatientForm.handleSubmit(onSubmit)}
            className="space-y-4"
          >
            <FormField
              control={addPatientForm.control}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="gap-3 grid">
                          {addPatientFormContentFields.fields.map(
                            (field, index) => (
                              <div
                                key={field.id}
                                  ...
                                  <FormControl>
                                    ...
                                    >
                                      <SelectTrigger
                                        className={cn(
                                          "w-[180px]",
                                          addPatientForm.formState.errors
                                            .content?.[index]?.dataType &&
            ...
            <FormField
              control={addPatientForm.control}
              name="isBlockchainPatient"
              render={({ field }) => (
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="isBlockchainPatient"
                    {...field}
                  ...
                  <div className="grid">
                    <Label
                      htmlFor="isBlockchainPatient"
                      className="text-sm font-medium cursor-pointer"
                    >
                      Blockchain Patient?
                    </Label>
                    <p className="text-xs text-gray-500">
                      Mark if the patient data should be stored on blockchain.
                    </p>
                  </div>
                </div>
              )}
