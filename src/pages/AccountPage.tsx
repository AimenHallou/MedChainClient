    ...
    return (
        <div className='flex-grow flex overflow-hidden'>
            <div className='w-full m-auto lg:max-w-5xl grid gap-6 mt-10'>
                <h1 className='font-semibold tracking-tight text-3xl text-center'>My Account</h1>
                ...
                <div className='flex items-start gap-x-4'>
                    ...
                    <Card className='min-w-[300px]'>
                        <CardHeader className='space-y-1'>
                            <CardTitle className='text-xl text-center'>MetaMask Connection</CardTitle>
                        </CardHeader>
                        <CardContent className='grid gap-5'>
                            <p>
                                Linked Address:{' '}
                                {address ? <span className='text-green-400'>{shortenAddress(address)}</span> : <span className='text-red-400'>N/A</span>}
                            </p>
                ...
                <form onSubmit={editForm.handleSubmit(onSubmit)} className='space-y-8'>
                    <Card>
                        ...
                        <CardContent className='grid gap-4'>
                            ...
                            {response && <p className='text-green-400 text-center text-sm'>{response}</p>}
